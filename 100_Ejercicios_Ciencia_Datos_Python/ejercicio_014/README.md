# Ejercicio 014 — Consumo y planes contratados

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_013/README.md) · [Siguiente](../ejercicio_015/README.md)

### Contexto

Un operador examina consumos mensuales. Sector: **telecomunicaciones**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Se atribuye el mayor consumo a todos los clientes de un plan. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Qué tan representativo es el consumo típico dentro de cada plan?
...
- [registros](datos/registros.csv): **109 registros**, 10 campos. Fuente principal: un cliente y fotografía temporal.
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **Clientes del mismo plan pueden diferir en antigüedad; dispersión no es error de medición.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Resume media, mediana, desviación estándar y cuantiles; explica qué medida elegirías para describir demanda.
...
**Dispersión; colas; sensibilidad.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **consumo y planes contratados**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Qué cambia según plan, antigüedad y fecha de observación? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Qué tan representativo es el consumo típico dentro de cada plan?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- Clientes del mismo plan pueden diferir en antigüedad; dispersión no es error de medición.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **Clientes del mismo plan pueden diferir en antigüedad; dispersión no es error de medición.**
...
Antes de consultar, escribe una pregunta concreta sobre **dispersión**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **Clientes del mismo plan pueden diferir en antigüedad; dispersión no es error de medición.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Compara el resultado con y sin el percentil superior, sin borrar el original. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

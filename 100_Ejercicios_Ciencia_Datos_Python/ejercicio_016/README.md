# Ejercicio 016 — Préstamos y devoluciones

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_015/README.md) · [Siguiente](../ejercicio_017/README.md)

### Contexto

Una biblioteca analiza el uso de su colección. Sector: **servicios culturales**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Los préstamos aún abiertos desaparecen del reporte de duración. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Qué se sabe de la duración de préstamos devueltos y de los que siguen abiertos?
...
- [registros](datos/registros.csv): **121 registros**, 7 campos. Fuente principal: un préstamo.
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **La duración observada de un préstamo abierto es un límite inferior.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Describe devoluciones, renovaciones y duración registrada por género; separa observaciones completas y abiertas.
...
**Censura; distribución; cobertura.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **préstamos y devoluciones**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Qué préstamos continúan abiertos y qué géneros predominan por sucursal? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Qué se sabe de la duración de préstamos devueltos y de los que siguen abiertos?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- La duración observada de un préstamo abierto es un límite inferior.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **La duración observada de un préstamo abierto es un límite inferior.**
...
Antes de consultar, escribe una pregunta concreta sobre **censura**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **La duración observada de un préstamo abierto es un límite inferior.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Representa por separado préstamos devueltos y abiertos sin fingir duraciones finales. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

# Ejercicio 018 — Resultados y repetibilidad

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_017/README.md) · [Siguiente](../ejercicio_019/README.md)

### Contexto

Un laboratorio docente compara lecturas de muestras sintéticas. Sector: **salud sintética y control de laboratorio**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Se promedian repeticiones como si fueran muestras independientes. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Cuánta variación corresponde a muestras y cuánta a mediciones repetidas?
...
- [registros](datos/registros.csv): **133 registros**, 9 campos. Fuente principal: una réplica de muestra e instrumento.
...
**Repetibilidad; independencia; jerarquía de datos.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **resultados y repetibilidad**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Cuántas muestras independientes respaldan cada resumen? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Cuánta variación corresponde a muestras y cuánta a mediciones repetidas?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- Una réplica no incrementa el número de muestras independientes.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **Una réplica no incrementa el número de muestras independientes.**
...
Antes de consultar, escribe una pregunta concreta sobre **repetibilidad**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
Contrasta instrumentos usando solo muestras medidas por ambos. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

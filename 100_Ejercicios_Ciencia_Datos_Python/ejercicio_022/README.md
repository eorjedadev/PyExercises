# Ejercicio 022 — Descuentos y valor de compra

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_021/README.md) · [Siguiente](../ejercicio_023/README.md)

### Contexto

Una librería revisa su política promocional. Sector: **comercio**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Se afirma que los descuentos generan compras mayores. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Cómo se relacionan descuentos y unidades dentro de cada producto?
...
- [registros](datos/registros.csv): **417 registros**, 8 campos. Fuente principal: una operación de un producto.
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **Los descuentos pueden dirigirse a compras grandes; asociación no demuestra efecto.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Explora asociación con unidades e importe neto, separa productos y estados y compara distribuciones.
...
**Correlación; confusión por producto; causalidad.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **descuentos y valor de compra**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿El orden por unidades coincide con el orden por importe? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Cómo se relacionan descuentos y unidades dentro de cada producto?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- Los descuentos pueden dirigirse a compras grandes; asociación no demuestra efecto.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **Los descuentos pueden dirigirse a compras grandes; asociación no demuestra efecto.**
...
Antes de consultar, escribe una pregunta concreta sobre **correlación**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **Los descuentos pueden dirigirse a compras grandes; asociación no demuestra efecto.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Redacta un diseño que permitiría evaluar causalmente una promoción futura. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

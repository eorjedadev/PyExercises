# Ejercicio 024 — Asistencia y resultados

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_023/README.md) · [Siguiente](../ejercicio_025/README.md)

### Contexto

Una coordinación académica evalúa apoyos. Sector: **educación**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

La asociación entre asistencia y nota se presenta como causal. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿La relación se mantiene al considerar la nota inicial y modalidad?
...
- [registros](datos/registros.csv): **433 registros**, 9 campos. Fuente principal: un alumno ficticio y su curso.
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **Motivación y disponibilidad no están medidas; el ajuste no elimina toda confusión.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Explora relaciones numéricas, estratifica por rendimiento previo y describe diferencias sin atribuir causalidad.
...
**Pearson; Spearman; confusión.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **asistencia y resultados**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Los resultados cambian al considerar rendimiento inicial y modalidad? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿La relación se mantiene al considerar la nota inicial y modalidad?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- Motivación y disponibilidad no están medidas; el ajuste no elimina toda confusión.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **Motivación y disponibilidad no están medidas; el ajuste no elimina toda confusión.**
...
Antes de consultar, escribe una pregunta concreta sobre **pearson**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **Motivación y disponibilidad no están medidas; el ajuste no elimina toda confusión.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Compara correlaciones lineales y de rangos y explica sus diferencias. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

# Ejercicio 032 — Comparaciones salariales responsables

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_031/README.md) · [Siguiente](../ejercicio_033/README.md)

### Contexto

Recursos humanos revisa remuneraciones ficticias. Sector: **recursos humanos sintéticos**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Se comparan salarios sin considerar jornada ni contrato. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Qué diferencias descriptivas persisten al considerar horas y antigüedad?
...
- [registros](datos/registros.csv): **497 registros**, 9 campos. Fuente principal: un trabajador ficticio en un mes.
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **No hay puesto ni desempeño; no se puede concluir discriminación ni ausencia de ella.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Compara salarios y remuneración por hora, distribuciones por área y tamaños por contrato; documenta límites del ajuste.
...
**Normalización; variables omitidas; comunicación.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **comparaciones salariales responsables**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿La jornada y antigüedad explican parte de la composición de los grupos? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Qué diferencias descriptivas persisten al considerar horas y antigüedad?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- No hay puesto ni desempeño; no se puede concluir discriminación ni ausencia de ella.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **No hay puesto ni desempeño; no se puede concluir discriminación ni ausencia de ella.**
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **No hay puesto ni desempeño; no se puede concluir discriminación ni ausencia de ella.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Define qué variables adicionales pedirías para una auditoría más sólida. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

# Ejercicio 044 — Tutorías y selección de alumnos

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_043/README.md) · [Siguiente](../ejercicio_045/README.md)

### Contexto

Un instituto relaciona tutorías y rendimiento. Sector: **educación**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

La mejora entre notas se atribuye al apoyo recibido. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Cómo cambia la comparación al considerar rendimiento inicial y modalidad?
...
- [registros](datos/registros.csv): **1,244 registros**, 9 campos. Fuente principal: un alumno ficticio y su curso.
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **Quienes reciben tutoría no fueron asignados al azar; regresión a la media puede influir.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Estudia cambio emparejado por alumno, participa o no en tutorías y estratos de nota inicial; plantea confusores.
...
**Comparaciones emparejadas; selección; regresión a la media.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **tutorías y selección de alumnos**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Los resultados cambian al considerar rendimiento inicial y modalidad? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Cómo cambia la comparación al considerar rendimiento inicial y modalidad?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- Quienes reciben tutoría no fueron asignados al azar; regresión a la media puede influir.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **Quienes reciben tutoría no fueron asignados al azar; regresión a la media puede influir.**
...
Antes de consultar, escribe una pregunta concreta sobre **comparaciones emparejadas**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **Quienes reciben tutoría no fueron asignados al azar; regresión a la media puede influir.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Diseña una evaluación futura con asignación aleatoria o criterios transparentes. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

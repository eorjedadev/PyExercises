# Ejercicio 057 — Campaña y cambio aparente

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_056/README.md) · [Siguiente](../ejercicio_058/README.md)

### Contexto

Un municipio inició una campaña en un distrito. Sector: **servicios urbanos**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Un cambio posterior se atribuye completamente a la campaña. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Qué evidencia descriptiva aporta la comparación antes/después y con otro distrito?
...
- [registros](datos/registros.csv): **2,158 registros**, 8 campos. Fuente principal: un recorrido en un distrito y día.
- [distritos](datos/distritos.csv): **3 registros**, 3 campos. Calendario administrativo, no prueba de cumplimiento de la campaña.
...
| Campo | Significado | Tipo esperado |
| --- | --- | --- |
| `distrito` | Clave | texto |
| `habitantes` | Población constante | entero |
| `campana_desde` | Inicio de campaña o ausencia de intervención | fecha |
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **La intervención no fue aleatoria; tendencias paralelas observadas no garantizan el supuesto futuro.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Usa intervención del 2024-07-01 en norte, compara tendencias previas y diferencias de cambios con cobertura; explicita supuestos causales.
...
**Diferencias en diferencias; tendencias; causalidad.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **campaña y cambio aparente**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Qué parte de la diferencia depende de población y días cubiertos? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Qué evidencia descriptiva aporta la comparación antes/después y con otro distrito?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- La intervención no fue aleatoria; tendencias paralelas observadas no garantizan el supuesto futuro.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **La intervención no fue aleatoria; tendencias paralelas observadas no garantizan el supuesto futuro.**
...
Antes de consultar, escribe una pregunta concreta sobre **diferencias en diferencias**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **La intervención no fue aleatoria; tendencias paralelas observadas no garantizan el supuesto futuro.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Utiliza una fecha placebo previa y examina sensibilidad. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

# Ejercicio 066 — Estacionalidad de consumo

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_065/README.md) · [Siguiente](../ejercicio_067/README.md)

### Contexto

Una administración tiene dos años de lecturas. Sector: **energía**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Un aumento de verano se presenta como tendencia permanente. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Qué parte del patrón corresponde a calendario y qué parte a cambio sostenido?
...
**Series temporales; estacionalidad; agregación.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **estacionalidad de consumo**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Qué cambia al considerar ocupación, clima y superficie? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Qué parte del patrón corresponde a calendario y qué parte a cambio sostenido?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- Dos ciclos anuales permiten explorar, pero no garantizar estacionalidad futura.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **Dos ciclos anuales permiten explorar, pero no garantizar estacionalidad futura.**
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **Dos ciclos anuales permiten explorar, pero no garantizar estacionalidad futura.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
Evalúa la conclusión usando agregación semanal y mensual. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

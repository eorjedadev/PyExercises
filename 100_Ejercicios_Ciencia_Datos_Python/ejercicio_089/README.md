# Ejercicio 089 — Encargo abierto de atención municipal

[Índice](../README.md#indice-de-ejercicios) · [Anterior](../ejercicio_088/README.md) · [Siguiente](../ejercicio_090/README.md)

### Contexto

Una municipalidad quiere decidir dónde observar el servicio presencial. Sector: **servicios públicos**. Todos los registros son sintéticos; las entidades y situaciones no describen organizaciones reales.

### Problema

Solo dispone de registros de atención y capacidad nominal. El encargo requiere comprobar esa lectura con evidencia, sin aceptar como conclusión lo que plantea la situación.

### Pregunta principal

¿Qué pregunta priorizarías para orientar una visita de diagnóstico?
...
- [registros](datos/registros.csv): **4,515 registros**, 7 campos. Fuente principal: una atención.
...
Evalúa ausencias, repeticiones, formatos, rangos y coherencia entre campos. En este contexto debes considerar: **La capacidad nominal no revela pausas ni llegadas fuera del sistema.** Para cada problema encontrado, registra evidencia, decisión —conservar, marcar, corregir, investigar, imputar o excluir—, justificación y efecto sobre la población. No borres nulos ni extremos por una regla universal. Mantén los originales y contrasta el resultado bajo una decisión alternativa razonable.

### Requisitos del análisis

Formula dos preguntas, elige una con criterio de impacto, integra fuentes y compara al menos dos explicaciones compatibles con los datos.
...
**Formulación de preguntas; decisión bajo información parcial.** Estudia qué pregunta responde cada concepto, bajo qué supuestos y qué puede ocultar. Relaciona su significado con la unidad de observación del paquete antes de elegir una función de biblioteca.
...
Convierte el encargo en evidencia sobre **encargo abierto de atención municipal**. Presenta la comparación principal y una alternativa que pueda cuestionarla; indica el tamaño de cada grupo o ventana y explica qué cambió al preparar los datos. ¿Qué cambia entre prioridades y entre atendidos y abandonos? Expón al menos una explicación rival antes de redactar una recomendación.

### Visualización

Diseña una figura que permita responder «¿Qué pregunta priorizarías para orientar una visita de diagnóstico?». Elige la representación según tipo de variable y audiencia. Incluye población, unidades, período y denominadores; añade incertidumbre cuando sea parte de tu metodología. Escribe una observación y una afirmación que esa figura no demuestra.
...
- La capacidad nominal no revela pausas ni llegadas fuera del sistema.
...
Aceptar la afirmación del problema sin comprobarla; confundir filas con entidades independientes; cambiar un denominador sin documentarlo; sumar o promediar sin revisar unidades; elegir el gráfico o la prueba que más favorezca una conclusión. En particular, explica cómo evitarías este riesgo: **La capacidad nominal no revela pausas ni llegadas fuera del sistema.**
...
Antes de consultar, escribe una pregunta concreta sobre **formulación de preguntas**. Después registra el apartado leído, su supuesto principal y cómo lo aplicaste. Consulta también la [guía de investigación](../RECURSOS.md); no busques un notebook resuelto del encargo.
...
¿Qué observaciones, variables o mecanismos de selección faltan para sostener una conclusión más fuerte? ¿Qué parte de la pregunta queda sin responder? Revisa especialmente: **La capacidad nominal no revela pausas ni llegadas fuera del sistema.** Los datos sintéticos sirven para entrenar razonamiento; sus patrones no estiman parámetros de una población real.
...
El presupuesto permite visitar una sola sede: cambia la recomendación y explicita incertidumbre. Conserva la primera versión, cambia solo las condiciones declaradas y compara evidencia y conclusión. Documenta qué componentes de tu código pudiste reutilizar y qué supuesto dejó de ser válido.

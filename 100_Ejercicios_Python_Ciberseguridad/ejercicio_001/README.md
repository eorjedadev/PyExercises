# Recursos del ejercicio 001

[Volver al enunciado](../ejercicio_001.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/inventario.csv](datos/inventario.csv)

Nombres y tamaños declarados; no existen ejecutables detrás de estas rutas.

CSV con cabecera: id, nombre, bytes. Delimitador coma, comillas dobles, UTF-8.

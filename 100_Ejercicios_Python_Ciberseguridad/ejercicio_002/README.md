# Recursos del ejercicio 002

[Volver al enunciado](../ejercicio_002.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/auth.csv](logs/auth.csv)

Un lote sin ventana temporal; estados exactos ok/fail. No contiene contraseñas.

CSV con cabecera: id, cuenta, origen, resultado. Delimitador coma, comillas dobles, UTF-8.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: umbral_fallos.

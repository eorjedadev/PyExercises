# Recursos del ejercicio 003

[Volver al enunciado](../ejercicio_003.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/origenes.json](datos/origenes.json)

Direcciones textuales, no destinos que deban contactarse.

JSON: lista de valores; el significado y tipo exigido están en el enunciado.

### [config/redes.json](config/redes.json)

Redes inventariadas explícitas; direcciones de documentación.

JSON: objeto; claves de primer nivel: lab-v4, lab-v6.

# Recursos del ejercicio 004

[Volver al enunciado](../ejercicio_004.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/servicios.csv](datos/servicios.csv)

Es una declaración de escucha; publicado representa alcance del inventario, no dirección IP.

CSV con cabecera: id, activo, protocolo, puerto, alcance. Delimitador coma, comillas dobles, UTF-8.

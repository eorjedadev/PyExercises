# Recursos del ejercicio 005

[Volver al enunciado](../ejercicio_005.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/permisos.csv](datos/permisos.csv)

Exportación sintética POSIX; no consultar esas rutas en el equipo.

CSV con cabecera: id, ruta, clase, modo. Delimitador coma, comillas dobles, UTF-8.

# Recursos del ejercicio 006

[Volver al enunciado](../ejercicio_006.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/archivos/normal.txt](datos/archivos/normal.txt)

Archivo inerte para leer como bytes; conservar sin modificar.

Contenido binario inerte; 24 bytes. No decodificar antes de una comprobación de integridad.

### [datos/archivos/cambiado.txt](datos/archivos/cambiado.txt)

Archivo inerte para leer como bytes; conservar sin modificar.

Contenido binario inerte; 20 bytes. No decodificar antes de una comprobación de integridad.

### [datos/archivos/vacio.txt](datos/archivos/vacio.txt)
...
Rutas relativas a datos/archivos; referencia hipotética no autenticada.

JSON: lista de registros; campos observados: ruta, sha256.

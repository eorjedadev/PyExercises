# Recursos del ejercicio 007

[Volver al enunciado](../ejercicio_007.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/eventos.json](logs/eventos.json)

Valores exclusivamente ficticios. La clasificación viene de claves, no de patrones de sus valores.

JSON: lista de registros; campos observados: actor, context, id, items, message, monkey, password.

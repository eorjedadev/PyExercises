# Recursos del ejercicio 008

[Volver al enunciado](../ejercicio_008.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/respuestas.json](datos/respuestas.json)

Cabeceras como mapa; H4 separa presencia de valor adecuado. No son respuestas de un servidor real.

JSON: lista de registros; campos observados: headers, id, scheme.

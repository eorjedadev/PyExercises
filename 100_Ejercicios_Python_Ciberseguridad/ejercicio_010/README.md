# Recursos del ejercicio 010

[Volver al enunciado](../ejercicio_010.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/firewall.csv](logs/firewall.csv)

Puertos destino y decisión declarada. No contiene paquetes ni obliga a transmitir tráfico.

CSV con cabecera: id, origen, destino, puerto, accion. Delimitador coma, comillas dobles, UTF-8.

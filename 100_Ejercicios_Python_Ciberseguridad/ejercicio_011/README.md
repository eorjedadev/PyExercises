# Recursos del ejercicio 011

[Volver al enunciado](../ejercicio_011.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/usuarios.csv](datos/usuarios.csv)

Logins tal como fueron exportados. Conservar id de fila aunque haya colisión de login.

CSV con cabecera: id, login, tipo, propietario. Delimitador coma, comillas dobles, UTF-8.

# Recursos del ejercicio 012

[Volver al enunciado](../ejercicio_012.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/sesiones.json](datos/sesiones.json)

IDs no son tokens. Fechas con zona; revoked booleano real.

JSON: lista de registros; campos observados: expires_at, id, issued_at, revoked.

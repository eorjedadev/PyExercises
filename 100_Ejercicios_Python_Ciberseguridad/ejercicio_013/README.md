# Recursos del ejercicio 013

[Volver al enunciado](../ejercicio_013.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/actividad.json](logs/actividad.json)

Acciones declaradas, sin instrucciones ejecutables.

JSON: lista de registros; campos observados: accion, activo, id, ts.

### [config/ventanas.json](config/ventanas.json)

Ventanas autorizadas de este laboratorio.

JSON: lista de registros; campos observados: activo, fin, id, inicio, ticket.

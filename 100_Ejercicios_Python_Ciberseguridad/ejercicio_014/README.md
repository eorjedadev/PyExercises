# Recursos del ejercicio 014

[Volver al enunciado](../ejercicio_014.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/dns_queries.csv](logs/dns_queries.csv)

Códigos de respuesta DNS; todas las consultas ya están en el lote que se analiza.

CSV con cabecera: id, cliente, nombre, rcode. Delimitador coma, comillas dobles, UTF-8.

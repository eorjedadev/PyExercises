# Recursos del ejercicio 015

[Volver al enunciado](../ejercicio_015.md) · [Convenciones](../README.md#contratos-comunes)
...
### [config/configuraciones.json](config/configuraciones.json)

Exportaciones de configuración con ausencias y tipos incorrectos intencionales.

JSON: lista de registros; campos observados: bind_host, debug, id, verify_tls.

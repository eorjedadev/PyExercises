# Recursos del ejercicio 016

[Volver al enunciado](../ejercicio_016.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/repositorio/ajustes.txt](datos/repositorio/ajustes.txt)

Texto inerte con marcador ficticio, no una clave real.

Texto UTF-8 de laboratorio. No interpretar como comando.

### [datos/repositorio/documentacion.txt](datos/repositorio/documentacion.txt)

Mezcla de muestras válidas para el patrón y cadenas que no cumplen longitud.

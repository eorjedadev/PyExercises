# Recursos del ejercicio 019

[Volver al enunciado](../ejercicio_019.md) · [Convenciones](../README.md#contratos-comunes)
...
Mapa ruta→huella. No requiere leer archivos fuera del paquete.

JSON: objeto; claves de primer nivel: app.cfg, viejo.txt, igual.txt.

### [datos/despues.json](datos/despues.json)

Segunda captura del mismo alcance declarado.

JSON: objeto; claves de primer nivel: app.cfg, nuevo.txt, igual.txt.

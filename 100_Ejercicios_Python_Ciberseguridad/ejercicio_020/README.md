# Recursos del ejercicio 020

[Volver al enunciado](../ejercicio_020.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/access.csv](logs/access.csv)

Status HTTP enteros textuales; rutas exactas sin normalización adicional.

CSV con cabecera: id, ruta, status. Delimitador coma, comillas dobles, UTF-8.

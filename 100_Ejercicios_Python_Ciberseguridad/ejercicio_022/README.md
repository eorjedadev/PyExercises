# Recursos del ejercicio 022

[Volver al enunciado](../ejercicio_022.md) · [Convenciones](../README.md#contratos-comunes)
...
Lote con patrón distribuido,repetición concentrada y ruido legítimo.

JSON: lista de registros; campos observados: cuenta, id, origen, resultado, ts.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: inicio, fin, cuentas_minimas, max_fallos_por_cuenta.

# Recursos del ejercicio 023

[Volver al enunciado](../ejercicio_023.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/intentos.json](datos/intentos.json)

Reloj de segundos relativo al inicio; no esperar ni autenticar realmente.

JSON: lista de registros; campos observados: cuenta, id, resultado, segundo.

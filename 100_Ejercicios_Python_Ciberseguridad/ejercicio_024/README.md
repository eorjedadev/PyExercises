# Recursos del ejercicio 024

[Volver al enunciado](../ejercicio_024.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/usuarios.json](datos/usuarios.json)

Estado declarativo de usuarios y MFA, no verificación del proveedor.

JSON: lista de registros; campos observados: habilitada, mfa, privilegiada, usuario.

### [config/excepciones.json](config/excepciones.json)

Excepciones del perfil local.

JSON: lista de registros; campos observados: aprobada, expires_at, id, usuario.

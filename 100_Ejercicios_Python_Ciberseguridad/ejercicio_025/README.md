# Recursos del ejercicio 025

[Volver al enunciado](../ejercicio_025.md) · [Convenciones](../README.md#contratos-comunes)
...
### [config/perfil_local.json](config/perfil_local.json)

Perfil pedagógico recibido, no implementar ni calcular scrypt para este ejercicio de metadatos.

JSON: objeto; claves de primer nivel: version, algoritmo, n, r, p, salt_bytes_min.

### [datos/verificadores.json](datos/verificadores.json)

Solo metadatos sintéticos. No hay hashes de contraseñas que deban adivinarse.

JSON: lista de registros; campos observados: id, n, p, r, salt_hex, scheme.

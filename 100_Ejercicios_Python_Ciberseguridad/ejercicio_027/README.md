# Recursos del ejercicio 027

[Volver al enunciado](../ejercicio_027.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/escenarios.json](datos/escenarios.json)

Guiones de prueba independientes: cada escenario emite su propio token durante la implementación. No se proporcionan tokens.

JSON: lista de registros; campos observados: consumos, emision, id.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: bytes_aleatorios, ttl_segundos, reloj_inicial.

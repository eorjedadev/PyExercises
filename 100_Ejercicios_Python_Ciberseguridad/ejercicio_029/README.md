# Recursos del ejercicio 029

[Volver al enunciado](../ejercicio_029.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/vector.json](datos/vector.json)

Vector público AES-128-GCM de laboratorio. La etiqueta se almacena separada; la API puede pedir ciphertext y etiqueta concatenados. No generar nuevos mensajes con esta clave/nonce.

JSON: objeto; claves de primer nivel: key_hex, nonce_hex, aad_hex, ciphertext_hex, tag_hex, plaintext_length.

### [datos/variantes.json](datos/variantes.json)

Aplicar cada variante sobre una copia independiente del vector, sin modificarlo.

JSON: lista de registros; campos observados: cambio, id, valor.

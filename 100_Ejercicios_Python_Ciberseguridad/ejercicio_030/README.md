# Recursos del ejercicio 030

[Volver al enunciado](../ejercicio_030.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/certificados.json](datos/certificados.json)

Metadatos extraídos ficticios; no son certificados que acrediten identidad.

JSON: lista de registros; campos observados: hostname, id, not_after, not_before, san.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: corte, dias_renovacion.

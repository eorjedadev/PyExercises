# Recursos del ejercicio 031

[Volver al enunciado](../ejercicio_031.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/solicitudes.json](datos/solicitudes.json)

Peticiones locales como datos; no exigen servidor.

JSON: lista de registros; campos observados: action, actor, id, object.

# Recursos del ejercicio 032

[Volver al enunciado](../ejercicio_032.md) · [Convenciones](../README.md#contratos-comunes)
...
Semilla para tabla SQLite temporal usuarios(id entero único,nombre texto); solo estos campos.

JSON: lista de registros; campos observados: id, nombre.

### [datos/consultas.json](datos/consultas.json)

Entradas literales de consulta para probar que no cambian la estructura SQL.

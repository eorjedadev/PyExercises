# Recursos del ejercicio 033

[Volver al enunciado](../ejercicio_033.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/nombres.json](datos/nombres.json)

Texto inerte sin scripts ni recursos externos. Solo se inserta en nodos de texto.

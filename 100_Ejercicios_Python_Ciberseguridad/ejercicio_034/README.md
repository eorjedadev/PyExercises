# Recursos del ejercicio 034

[Volver al enunciado](../ejercicio_034.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/cookies.json](datos/cookies.json)

No incluye valores de cookies. Campos de controles son booleanos reales.

JSON: lista de registros; campos observados: HttpOnly, SameSite, Secure, excepcion_aprobada, name, tipo.

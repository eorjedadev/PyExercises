# Recursos del ejercicio 035

[Volver al enunciado](../ejercicio_035.md) · [Convenciones](../README.md#contratos-comunes)
...
Tokens públicos ficticios para un modelo de decisión, no generación profesional de secretos.

JSON: lista de registros; campos observados: cambio, id, method, origin, token.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: origin_permitido, token_prueba.

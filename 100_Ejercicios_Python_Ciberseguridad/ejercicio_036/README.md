# Recursos del ejercicio 036

[Volver al enunciado](../ejercicio_036.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/urls.json](datos/urls.json)

URLs de documentación; nunca resolver ni contactar estos destinos.

# Recursos del ejercicio 037

[Volver al enunciado](../ejercicio_037.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/miembros.json](datos/miembros.json)

Manifiesto ficticio, no ZIP real: analizar cada miembro y decisión global. Z1 puede probarse solo en una copia.

JSON: lista de registros; campos observados: compressed, id, path, type, uncompressed.

# Recursos del ejercicio 038

[Volver al enunciado](../ejercicio_038.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/adjuntos.json](datos/adjuntos.json)

Solo cabeceras hex, no documentos PDF ejecutables; extensión se compara sin mayúsculas.

JSON: lista de registros; campos observados: id, mime, name, prefix_hex.

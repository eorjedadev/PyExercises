# Recursos del ejercicio 041

[Volver al enunciado](../ejercicio_041.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/dependencias.json](datos/dependencias.json)

Nombres y versiones ficticios; no representan avisos de paquetes reales.

JSON: lista de registros; campos observados: ecosistema, id, nombre, version.

### [datos/avisos.json](datos/avisos.json)

Feed ficticio cerrado; no son CVE ni reglas de versión universales.

JSON: lista de registros; campos observados: ecosistema, id, max_exclusive, min, nombre.

# Recursos del ejercicio 042

[Volver al enunciado](../ejercicio_042.md) · [Convenciones](../README.md#contratos-comunes)
...
### [config/entornos_simulados.json](config/entornos_simulados.json)

Mapas simulados, no leer ni volcar os.environ real.

JSON: lista de registros; campos observados: id, variables.

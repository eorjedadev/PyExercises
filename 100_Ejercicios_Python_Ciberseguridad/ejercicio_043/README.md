# Recursos del ejercicio 043

[Volver al enunciado](../ejercicio_043.md) · [Convenciones](../README.md#contratos-comunes)
...
Entradas para serializar como JSONL. J4 es un rechazo intencional.

JSON: lista de registros; campos observados: actor, id, message.

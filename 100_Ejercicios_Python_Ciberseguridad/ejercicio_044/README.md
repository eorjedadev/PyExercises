# Recursos del ejercicio 044

[Volver al enunciado](../ejercicio_044.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/grupos.json](datos/grupos.json)

Membresías de un nivel; no hay grupos implícitos.

JSON: objeto; claves de primer nivel: lectores, operadores.

### [config/reglas.json](config/reglas.json)

Lenguaje simplificado con deny prevalente; no es ACL nativa de un sistema.

JSON: lista de registros; campos observados: action, effect, id, resource, subject, subject_type.

### [datos/solicitudes.json](datos/solicitudes.json)

Solicitudes contra reglas y grupos declarados.

JSON: lista de registros; campos observados: action, id, resource, user.

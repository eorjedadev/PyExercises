# Recursos del ejercicio 045

[Volver al enunciado](../ejercicio_045.md) · [Convenciones](../README.md#contratos-comunes)
...
Captura anterior; token es ficticio.

JSON: objeto; claves de primer nivel: debug, timeout, auth, retirado.

### [datos/despues.json](datos/despues.json)

Captura posterior; secretos siempre redactados en resultados.

JSON: objeto; claves de primer nivel: debug, timeout, auth, nuevo.

### [config/aprobaciones.json](config/aprobaciones.json)

Rutas lógicas con punto; en estos datos las claves no contienen puntos. Solo approved verdadero cubre.

JSON: lista de registros; campos observados: approved, new_value, path, secret_change, ticket.

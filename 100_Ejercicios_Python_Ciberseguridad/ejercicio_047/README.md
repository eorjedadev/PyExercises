# Recursos del ejercicio 047

[Volver al enunciado](../ejercicio_047.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/origen.log](logs/origen.log)

UTF-8; dos líneas completas y un fragmento final intencional. El offset se mide en bytes.

Log de líneas físicas UTF-8. Revisa las excepciones deliberadas y la unidad de lectura indicadas en su descripción.

### [config/control.json](config/control.json)

Punto de control inicial; la identidad del archivo del laboratorio es segmento-A.

JSON: objeto; claves de primer nivel: identity, offset.

# Recursos del ejercicio 049

[Volver al enunciado](../ejercicio_049.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/adquisiciones.json](datos/adquisiciones.json)

Identidad inicial declarada por evidencia.

JSON: objeto; claves de primer nivel: E1, E2.

### [logs/transferencias.json](logs/transferencias.json)

Registro de custodia sintético. No demuestra quién realizó realmente la adquisición.

JSON: lista de registros; campos observados: evidence, from, id, sha256, to, ts.

# Recursos del ejercicio 050

[Volver al enunciado](../ejercicio_050.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/artefactos.json](datos/artefactos.json)

Edad computada desde acquired_at; hold booleano. No se entrega ninguna operación de borrado.

JSON: lista de registros; campos observados: acquired_at, hold, id.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: corte, retencion_dias.

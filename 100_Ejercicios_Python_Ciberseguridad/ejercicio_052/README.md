# Recursos del ejercicio 052

[Volver al enunciado](../ejercicio_052.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/alertas.json](logs/alertas.json)

Alertas no deben desaparecer de los resultados por estar exceptuadas.

JSON: lista de registros; campos observados: asset, id, rule, ts.

### [config/excepciones.json](config/excepciones.json)

EX2 utiliza wildcard que el lenguaje del ejercicio no permite.

JSON: lista de registros; campos observados: approver, asset, end, id, rule, start, ticket.

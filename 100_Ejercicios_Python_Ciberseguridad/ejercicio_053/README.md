# Recursos del ejercicio 053

[Volver al enunciado](../ejercicio_053.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/predicciones.json](datos/predicciones.json)

Decisiones booleanas de una regla hipotética.

JSON: lista de registros; campos observados: alert, id.

### [datos/etiquetas.json](datos/etiquetas.json)

Verdad de laboratorio conocida solo para evaluar esta muestra; no inferir etiquetas en casos reales.

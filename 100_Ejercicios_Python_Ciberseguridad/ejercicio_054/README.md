# Recursos del ejercicio 054

[Volver al enunciado](../ejercicio_054.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/sensores.json](datos/sensores.json)

Inventario de sensores esperados.

JSON: lista de registros; campos observados: asset, id.

### [logs/latidos.json](logs/latidos.json)

C no tiene latidos y D tiene uno futuro; no corregirlos.

JSON: lista de registros; campos observados: id, sensor, ts.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: corte, max_edad_segundos.

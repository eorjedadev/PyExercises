# Recursos del ejercicio 055

[Volver al enunciado](../ejercicio_055.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/conexiones.json](logs/conexiones.json)

Origin y destination son identificadores de host; puertos destino y decisiones del sensor.

JSON: lista de registros; campos observados: action, destination, id, origin, port, ts.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: inicio, fin, puertos_minimos.

### [datos/roles.json](datos/roles.json)

Contexto que permite plantear explicaciones, no una autorización de escaneo demostrada.

JSON: lista de registros; campos observados: host, rol_declarado.

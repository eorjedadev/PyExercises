# Recursos del ejercicio 056

[Volver al enunciado](../ejercicio_056.md) · [Convenciones](../README.md#contratos-comunes)
...
El alcance interno depende de este inventario y no de is_private.

JSON: lista de registros; campos observados: id, internal, ip, role.

### [logs/conexiones.json](logs/conexiones.json)

Hosts como identidades de inventario; origen fuera de inventario se conserva con contexto faltante.

JSON: lista de registros; campos observados: destination, id, origin, port, protocol, ts.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: inicio, fin, destinos_minimos.

# Recursos del ejercicio 058

[Volver al enunciado](../ejercicio_058.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/transferencias.json](logs/transferencias.json)

Mismo periodo de observación; bytes_out ya indica dirección saliente.

JSON: lista de registros; campos observados: asset, bytes_out, destination, id.

### [datos/referencias.json](datos/referencias.json)

Referencia suministrada comparable en duración; no estadística universal.

JSON: lista de registros; campos observados: asset, bytes_out, destination.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: min_bytes, factor.

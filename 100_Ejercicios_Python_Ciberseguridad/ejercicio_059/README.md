# Recursos del ejercicio 059

[Volver al enunciado](../ejercicio_059.md) · [Convenciones](../README.md#contratos-comunes)
...
Incluye tiempo duplicado en A; registrar la duplicación y conservar una observación temporal para calcular intervalos.

JSON: lista de registros; campos observados: asset, destination, id, ts.

### [datos/roles.json](datos/roles.json)

Roles declarados para hipótesis alternativas, no etiquetas de benignidad.

JSON: lista de registros; campos observados: asset, role.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: min_eventos, tolerancia_segundos.

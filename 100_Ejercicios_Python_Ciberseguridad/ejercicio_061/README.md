# Recursos del ejercicio 061

[Volver al enunciado](../ejercicio_061.md) · [Convenciones](../README.md#contratos-comunes)
...
Usuarios conocidos, inicialmente habilitados.

JSON: lista de valores; el significado y tipo exigido están en el enunciado.

### [logs/cambios.json](logs/cambios.json)

Cambios de identidad observados, no decisiones que deba ejecutar el alumno.

JSON: lista de registros; campos observados: action, id, ts, user.

### [logs/auth.json](logs/auth.json)

Eventos de autenticación, no uso de sesión preexistente.

JSON: lista de registros; campos observados: id, result, ts, user.

# Recursos del ejercicio 062

[Volver al enunciado](../ejercicio_062.md) · [Convenciones](../README.md#contratos-comunes)
...
Cambios ya observados; solo new_role admin requiere esta comprobación.

JSON: lista de registros; campos observados: actor, id, new_role, ts, user.

### [datos/tickets.json](datos/tickets.json)

Tickets vinculados por usuario,rol,aprobación e intervalo.

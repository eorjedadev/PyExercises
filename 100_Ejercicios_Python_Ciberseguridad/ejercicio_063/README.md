# Recursos del ejercicio 063

[Volver al enunciado](../ejercicio_063.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/windows.json](logs/windows.json)

Exportación simplificada; event_id representa EventID y LogonType el valor oficial. No es un archivo EVTX.

JSON: lista de registros; campos observados: LogonType, account, event_id, host, id, ts, version.

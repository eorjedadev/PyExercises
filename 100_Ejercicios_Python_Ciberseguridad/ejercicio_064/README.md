# Recursos del ejercicio 064

[Volver al enunciado](../ejercicio_064.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/linux.json](logs/linux.json)

Eventos ya normalizados, no promesa de formato idéntico de journal o auth.log entre distribuciones.

JSON: lista de registros; campos observados: command, distro, event, id, session_id, ts, user.

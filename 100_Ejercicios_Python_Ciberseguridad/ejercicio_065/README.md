# Recursos del ejercicio 065

[Volver al enunciado](../ejercicio_065.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/procesos.json](datos/procesos.json)

ppid nulo indica raíz declarada. Solapamiento de P6/P7 crea ambigüedad intencional de captura.

JSON: lista de registros; campos observados: boot_id, end, host, id, name, pid, ppid, start.

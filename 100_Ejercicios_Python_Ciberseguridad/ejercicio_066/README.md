# Recursos del ejercicio 066

[Volver al enunciado](../ejercicio_066.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/antes.json](datos/antes.json)

Primera captura de tareas, no comandos que deban ejecutarse.

JSON: lista de registros; campos observados: description, executable, frequency, host, task_id.

### [datos/despues.json](datos/despues.json)

Segunda captura tomada en el instante configurado.

JSON: lista de registros; campos observados: description, executable, frequency, host, task_id.

### [datos/tickets.json](datos/tickets.json)

Autorización exacta para alta de T2. Comparar cambios contra instante de captura.

JSON: lista de registros; campos observados: approved, end, host, id, start, task_id.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: captura_despues.

# Recursos del ejercicio 067

[Volver al enunciado](../ejercicio_067.md) · [Convenciones](../README.md#contratos-comunes)
...
Captura anterior de entradas, id estable por entrada.

JSON: lista de registros; campos observados: command, id, location, platform.

### [datos/despues.json](datos/despues.json)

Cadenas inertes; evaluar prefijos literales, sin interpretar argumentos o variables.

JSON: lista de registros; campos observados: command, id, location, platform.

### [config/perfil.json](config/perfil.json)

Prefijos exactos sensibles a mayúsculas en este contrato lexical portable.

JSON: objeto; claves de primer nivel: windows, linux.

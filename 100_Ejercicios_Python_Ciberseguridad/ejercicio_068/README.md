# Recursos del ejercicio 068

[Volver al enunciado](../ejercicio_068.md) · [Convenciones](../README.md#contratos-comunes)
...
Éxitos y fallos de autenticación: usar solo éxitos para la correlación solicitada.

JSON: lista de registros; campos observados: cuenta, destino, id, origen, resultado, ts.

### [logs/firewall.json](logs/firewall.json)

Origen coincide con IP textual de auth; destino con id de host de la misma fuente. N3 queda a31s.

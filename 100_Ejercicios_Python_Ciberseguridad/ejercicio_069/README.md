# Recursos del ejercicio 069

[Volver al enunciado](../ejercicio_069.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/identidades.json](datos/identidades.json)

Identidades autenticadas por supuesto del laboratorio; no implementar login.

JSON: objeto; claves de primer nivel: ana, beto, auditora.

### [datos/objetos.json](datos/objetos.json)

Inventario de propietarios. No incluir name de objetos ajenos en respuestas públicas.

JSON: lista de registros; campos observados: id, name, owner.

### [logs/autorizaciones.json](logs/autorizaciones.json)

Decisiones registradas que deben contrastarse; status no confirma entrega de contenido.

JSON: lista de registros; campos observados: action, actor, decision, id, object, status.

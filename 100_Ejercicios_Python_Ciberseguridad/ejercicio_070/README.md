# Recursos del ejercicio 070

[Volver al enunciado](../ejercicio_070.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/lecturas.json](logs/lecturas.json)

Eventos completos en la ventana de laboratorio; se cuentan objetos distintos.

JSON: lista de registros; campos observados: action, id, object, result, ts, user.

### [datos/tareas.json](datos/tareas.json)

Una tarea solo cubre una parte de los objetos de cora.

JSON: lista de registros; campos observados: approved, end, id, objects, start, user.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: inicio, fin, umbral_objetos.

# Recursos del ejercicio 071

[Volver al enunciado](../ejercicio_071.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/accesos.json](logs/accesos.json)

Todos son éxitos; ubicaciones ficticias, sin geolocalización de personas.

JSON: lista de registros; campos observados: id, location, ts, user, vpn.

### [datos/distancias.json](datos/distancias.json)

Distancias simétricas dadas; misma ubicación equivale a0km; otras parejas no están cubiertas.

JSON: lista de registros; campos observados: from, km, to.

# Recursos del ejercicio 072

[Volver al enunciado](../ejercicio_072.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/proxy.json](logs/proxy.json)

XFF es dato declarado por la cadena HTTP, no prueba independiente de origen.

JSON: lista de registros; campos observados: id, peer_ip, xff.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: proxies_confiados.

# Recursos del ejercicio 073

[Volver al enunciado](../ejercicio_073.md) · [Convenciones](../README.md#contratos-comunes)
...
Intervalos de observación declarados; endpoint no tiene cobertura.

JSON: lista de registros; campos observados: end, source, start.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: inicio, fin, fuentes_requeridas.

# Recursos del ejercicio 074

[Volver al enunciado](../ejercicio_074.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/reenvios.json](logs/reenvios.json)

Payload contiene los campos sustantivos completos del evento. Registrar todas las procedencias.

JSON: lista de registros; campos observados: collector, event_id, origin, payload, received_at.

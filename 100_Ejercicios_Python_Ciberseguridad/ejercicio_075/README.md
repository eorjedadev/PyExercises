# Recursos del ejercicio 075

[Volver al enunciado](../ejercicio_075.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/versiones.json](logs/versiones.json)

La semántica de status/outcome es la declarada por este contrato, no la de todos los sensores reales.

JSON: lista de registros; campos observados: id, outcome, principal, source, status, ts, user, version.

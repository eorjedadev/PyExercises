# Recursos del ejercicio 076

[Volver al enunciado](../ejercicio_076.md) · [Convenciones](../README.md#contratos-comunes)
...
Campos admitidos por regla: failures entero no negativo y type texto.

JSON: lista de registros; campos observados: failures, id, type.

### [config/reglas_validas.json](config/reglas_validas.json)

Configuración válida; devolver todas las coincidencias, no solo primera.

JSON: objeto; claves de primer nivel: version, rules.

### [config/reglas_invalidas.json](config/reglas_invalidas.json)

Caso negativo independiente; no mezclar con la configuración válida.

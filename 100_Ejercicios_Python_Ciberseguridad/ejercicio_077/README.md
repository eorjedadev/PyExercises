# Recursos del ejercicio 077

[Volver al enunciado](../ejercicio_077.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/lote.json](datos/lote.json)

101 registros pequeños; procesar100 y declarar1 pendiente.

JSON: lista de registros; campos observados: id, message.

### [datos/registro_grande.txt](datos/registro_grande.txt)

Contenido de4097 bytes ASCII sin LF; es un caso separado para la frontera de tamaño.
...
JSON: objeto; claves de primer nivel: max_registros, max_bytes_registro.

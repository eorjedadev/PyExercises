# Recursos del ejercicio 080

[Volver al enunciado](../ejercicio_080.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/tiempos.json](logs/tiempos.json)

Instantes observados; la corrección no reemplaza el texto original.

JSON: lista de registros; campos observados: id, observed_at, source.

### [datos/calibracion.json](datos/calibracion.json)

offset = reloj de fuente menos referencia. Error simétrico en segundos; se permiten intervalos que cruzan la fecha.

JSON: lista de registros; campos observados: error_seconds, offset_seconds, source.

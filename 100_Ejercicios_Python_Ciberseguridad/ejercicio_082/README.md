# Recursos del ejercicio 082

[Volver al enunciado](../ejercicio_082.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/flujos.json](logs/flujos.json)

No contiene payload ni lista de archivos transferidos.

JSON: lista de registros; campos observados: asset, bytes_out, destination, id, ts.

### [datos/copias_aprobadas.json](datos/copias_aprobadas.json)

Aprobación por activo,destino y ventana; no cubre otro destino ni otro instante.

JSON: lista de registros; campos observados: approved, asset, destination, end, id, start.

### [datos/alcance.json](datos/alcance.json)

Limitaciones explícitas para evaluar qué puede concluirse.

JSON: objeto; claves de primer nivel: content_capture, data_classification_available, flow_coverage.

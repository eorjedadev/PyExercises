# Recursos del ejercicio 083

[Volver al enunciado](../ejercicio_083.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/cambios_archivos.json](logs/cambios_archivos.json)

Solo historial inerte; no crear ni modificar las rutas declaradas.

JSON: lista de registros; campos observados: host, id, job_id, operation, path, ts.

### [datos/trabajos.json](datos/trabajos.json)

Contexto de trabajo autorizado; no prueba de que todos los efectos fueran los previstos.

JSON: lista de registros; campos observados: approved, end, host, id, purpose, start.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: inicio, fin, rutas_minimas.

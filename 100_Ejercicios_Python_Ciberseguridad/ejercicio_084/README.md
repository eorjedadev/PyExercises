# Recursos del ejercicio 084

[Volver al enunciado](../ejercicio_084.md) · [Convenciones](../README.md#contratos-comunes)
...
Rutas de aplicación ficticia. No se entregan ni ejecutan exploits.

JSON: lista de registros; campos observados: host, id, path, request_id, status, ts.

### [logs/procesos.json](logs/procesos.json)

Nombres de procesos ficticios. request_id es trazabilidad declarada por la fuente.

JSON: lista de registros; campos observados: host, id, name, request_id, ts.

### [datos/cobertura.json](datos/cobertura.json)

No inferir creación de archivos o ejecución de malware donde no existe fuente.

JSON: objeto; claves de primer nivel: process_capture, file_writes.

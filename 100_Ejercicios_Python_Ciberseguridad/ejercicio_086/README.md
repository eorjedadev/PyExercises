# Recursos del ejercicio 086

[Volver al enunciado](../ejercicio_086.md) · [Convenciones](../README.md#contratos-comunes)
...
### [config/cargas.json](config/cargas.json)

Modelo JSON explícito, no manifiesto ejecutable ni comando para desplegar.

JSON: lista de registros; campos observados: id, mounts, privileged, rootfs_readonly, run_as_uid.

### [datos/excepciones.json](datos/excepciones.json)

La excepción aporta contexto; conservar la observación del control elevado.

JSON: lista de registros; campos observados: approved, control, load_id, owner, reason.

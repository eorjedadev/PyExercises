# Recursos del ejercicio 087

[Volver al enunciado](../ejercicio_087.md) · [Convenciones](../README.md#contratos-comunes)
...
### [config/politica.json](config/politica.json)

Solo comodín total *. Ninguna sintaxis de proveedor cloud real.

JSON: lista de registros; campos observados: action, actor, effect, id, resource.

### [datos/solicitudes.json](datos/solicitudes.json)

Solicitudes de evaluación offline; no acciones contra recursos reales.

JSON: lista de registros; campos observados: action, actor, id, resource.

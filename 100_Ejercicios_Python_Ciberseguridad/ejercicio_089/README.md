# Recursos del ejercicio 089

[Volver al enunciado](../ejercicio_089.md) · [Convenciones](../README.md#contratos-comunes)
...
Cada id es una alerta distinta; no perder categorías al agrupar.

JSON: lista de registros; campos observados: asset, category, id, ts.

### [datos/contexto.json](datos/contexto.json)

Contexto deliberadamente incompleto, no etiquetas de incidente.

JSON: objeto; claves de primer nivel: A, B.

# Recursos del ejercicio 090

[Volver al enunciado](../ejercicio_090.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/servicios.json](datos/servicios.json)

Modelo: basta uno de los hosts declarados para disponibilidad de cada servicio.

JSON: objeto; claves de primer nivel: portal, archivo, monitor.

### [datos/activos.json](datos/activos.json)

Inventario cerrado de hosts del modelo.

JSON: lista de valores; el significado y tipo exigido están en el enunciado.

### [datos/propuestas.json](datos/propuestas.json)

Escenarios independientes de planificación, nunca comandos de aislamiento.

JSON: lista de registros; campos observados: id, isolate.

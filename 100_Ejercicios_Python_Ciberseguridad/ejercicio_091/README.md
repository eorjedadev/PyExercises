# Recursos del ejercicio 091

[Volver al enunciado](../ejercicio_091.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/escenarios_recuperacion.json](datos/escenarios_recuperacion.json)

Resultados hipotéticos para cada escenario independiente; no son pruebas realmente ejecutadas en un sistema.

JSON: lista de registros; campos observados: expected_sha256, functional, id, observed_sha256, security.

### [datos/alcance_pruebas.json](datos/alcance_pruebas.json)

Alcance limitado de los resultados declarados.

JSON: objeto; claves de primer nivel: functional, security, capture_at.

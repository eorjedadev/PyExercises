# Recursos del ejercicio 092

[Volver al enunciado](../ejercicio_092.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/evidencia_original.json](datos/evidencia_original.json)

Material sintético que debe mantenerse sin cambios. Tokens son texto ficticio, no credenciales reales.

JSON: lista de registros; campos observados: action, email, event_id, token, ts, user.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: campos_compartidos, prefijo_alias, digitos_alias.

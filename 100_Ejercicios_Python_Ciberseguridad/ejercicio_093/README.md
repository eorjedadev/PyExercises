# Recursos del ejercicio 093

[Volver al enunciado](../ejercicio_093.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/feed_v1.json](datos/feed_v1.json)

Indicadores ficticios. La confianza es declaración de la fuente, no conclusión del analista.

JSON: lista de registros; campos observados: confidence, expires_at, id, source, type, value.

### [logs/observaciones.json](logs/observaciones.json)

Observaciones de fuentes sintéticas; tipo controla normalización.

JSON: lista de registros; campos observados: id, type, value.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: corte.

### [datos/feed_v2.json](datos/feed_v2.json)

Versión2 retira IOC1, amplía vigencia de IOC2 y añade IOC5. No reescribir resultados históricos.

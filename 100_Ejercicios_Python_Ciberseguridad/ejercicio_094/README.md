# Recursos del ejercicio 094

[Volver al enunciado](../ejercicio_094.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/defectuoso.log](logs/defectuoso.log)

JSONL intencionalmente defectuoso: máximo se mide sin LF, conservar línea física. El archivo completo no se carga como un único JSON.

Log de líneas físicas UTF-8. Revisa las excepciones deliberadas y la unidad de lectura indicadas en su descripción.

### [config/parametros.json](config/parametros.json)

Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: max_bytes_linea.
...
Este paquete incluye un log deliberadamente defectuoso. Consérvalo tal como se recibió; su tratamiento forma parte del ejercicio.

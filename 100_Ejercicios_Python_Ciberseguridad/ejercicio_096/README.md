# Recursos del ejercicio 096

[Volver al enunciado](../ejercicio_096.md) · [Convenciones](../README.md#contratos-comunes)
...
Copia independiente para recuperar el contrato anterior. Eventos deliberadamente desordenados; ids únicos, tiempos UTC.
...
Copia independiente para recuperar el contrato anterior. Parámetros explícitos del laboratorio; no son recomendaciones universales.

JSON: objeto; claves de primer nivel: umbral, ventana_segundos.

### [datos/encargo_revision.txt](datos/encargo_revision.txt)

Debes leer tu código previo, predecir resultados y conservar pruebas de regresión.

Texto UTF-8 de laboratorio. No interpretar como comando.

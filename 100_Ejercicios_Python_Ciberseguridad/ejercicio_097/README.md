# Recursos del ejercicio 097

[Volver al enunciado](../ejercicio_097.md) · [Convenciones](../README.md#contratos-comunes)
...
### [logs/volumen.log](logs/volumen.log)

20000 líneas JSONL con50 cuentas sintéticas y3 líneas defectuosas; no leer todas a una lista.

Log de líneas físicas UTF-8. Revisa las excepciones deliberadas y la unidad de lectura indicadas en su descripción.

### [logs/muestra.log](logs/muestra.log)

Muestra independiente para comprobar un resultado manual.

# Recursos del ejercicio 098

[Volver al enunciado](../ejercicio_098.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/eventos.json](datos/eventos.json)

Conteos ya medidos por ventana; comparar políticas sobre las mismas observaciones.

JSON: lista de registros; campos observados: failures, id, service.

### [datos/etiquetas.json](datos/etiquetas.json)

Verdad sintética para evaluación; batch no tiene positivos reales en esta muestra.

JSON: lista de registros; campos observados: id, positive.

### [config/versiones.json](config/versiones.json)

Configuración separada de etiquetas; no adaptar a mano tras ver resultados.

JSON: objeto; claves de primer nivel: v1, v2.

# Recursos del ejercicio 099

[Volver al enunciado](../ejercicio_099.md) · [Convenciones](../README.md#contratos-comunes)
...
### [datos/afirmaciones.json](datos/afirmaciones.json)

Afirmaciones para evaluar, no conclusiones del material.

JSON: lista de registros; campos observados: cited, claim, id.

### [datos/evidencias.json](datos/evidencias.json)

Hashes de dos capturas declaradas del mismo archivo y una declaración no corroborada.

JSON: lista de registros; campos observados: id, kind, path, result, sha256, text, ts, user.

### [datos/cobertura.json](datos/cobertura.json)

Sin cobertura de procesos. El testimonio no agrega esa cobertura.

JSON: objeto; claves de primer nivel: auth, hashes, processes.

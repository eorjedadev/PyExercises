# Ejercicio 001. Gestor de inventario con alertas
...
Construir una solucion funcional para `Gestor de inventario con alertas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 002. Agenda de contactos con busqueda inteligente
...
Construir una solucion funcional para `Agenda de contactos con busqueda inteligente` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 003. Control de gastos personales
...
Construir una solucion funcional para `Control de gastos personales` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

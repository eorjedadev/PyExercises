# Ejercicio 004. Sistema de reservas para una sala
...
Construir una solucion funcional para `Sistema de reservas para una sala` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

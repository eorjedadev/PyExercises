# Ejercicio 006. Registro de alumnos y promedios
...
Construir una solucion funcional para `Registro de alumnos y promedios` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

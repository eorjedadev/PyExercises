# Ejercicio 007. Planificador semanal de tareas
...
Construir una solucion funcional para `Planificador semanal de tareas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

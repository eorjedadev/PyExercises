# Ejercicio 009. Sistema de turnos para atencion
...
Construir una solucion funcional para `Sistema de turnos para atencion` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 010. Gestor de metas y progreso
...
Construir una solucion funcional para `Gestor de metas y progreso` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

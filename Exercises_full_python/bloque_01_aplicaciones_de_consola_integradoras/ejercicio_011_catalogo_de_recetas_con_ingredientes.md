# Ejercicio 011. Catalogo de recetas con ingredientes
...
Construir una solucion funcional para `Catalogo de recetas con ingredientes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

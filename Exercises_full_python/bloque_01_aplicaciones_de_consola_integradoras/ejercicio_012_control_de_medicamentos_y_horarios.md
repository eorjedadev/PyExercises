# Ejercicio 012. Control de medicamentos y horarios
...
Construir una solucion funcional para `Control de medicamentos y horarios` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 013. Registro de ventas por vendedor
...
Construir una solucion funcional para `Registro de ventas por vendedor` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

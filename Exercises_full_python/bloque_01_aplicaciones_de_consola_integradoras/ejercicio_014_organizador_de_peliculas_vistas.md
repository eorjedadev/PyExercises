# Ejercicio 014. Organizador de peliculas vistas
...
Construir una solucion funcional para `Organizador de peliculas vistas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

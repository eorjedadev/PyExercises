# Ejercicio 015. Sistema de pedidos de restaurante
...
Construir una solucion funcional para `Sistema de pedidos de restaurante` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

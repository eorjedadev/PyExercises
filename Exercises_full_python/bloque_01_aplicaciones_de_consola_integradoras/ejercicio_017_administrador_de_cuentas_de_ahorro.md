# Ejercicio 017. Administrador de cuentas de ahorro
...
Construir una solucion funcional para `Administrador de cuentas de ahorro` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

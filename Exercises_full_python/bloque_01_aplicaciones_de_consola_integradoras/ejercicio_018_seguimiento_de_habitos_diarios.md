# Ejercicio 018. Seguimiento de habitos diarios
...
Construir una solucion funcional para `Seguimiento de habitos diarios` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

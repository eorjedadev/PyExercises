# Ejercicio 019. Gestor de mantenimiento de equipos
...
Construir una solucion funcional para `Gestor de mantenimiento de equipos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

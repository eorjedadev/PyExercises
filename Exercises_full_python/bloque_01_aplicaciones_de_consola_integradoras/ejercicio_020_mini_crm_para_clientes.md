# Ejercicio 020. Mini CRM para clientes
...
Construir una solucion funcional para `Mini CRM para clientes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

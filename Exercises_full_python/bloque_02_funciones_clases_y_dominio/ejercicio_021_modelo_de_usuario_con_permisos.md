# Ejercicio 021. Modelo de usuario con permisos
...
Construir una solucion funcional para `Modelo de usuario con permisos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

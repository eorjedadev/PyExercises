# Ejercicio 022. Carrito de compras con descuentos
...
Construir una solucion funcional para `Carrito de compras con descuentos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

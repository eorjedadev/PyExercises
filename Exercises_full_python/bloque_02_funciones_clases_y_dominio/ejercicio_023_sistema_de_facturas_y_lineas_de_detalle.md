# Ejercicio 023. Sistema de facturas y lineas de detalle
...
Construir una solucion funcional para `Sistema de facturas y lineas de detalle` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

## Area de entrenamiento

Funciones, clases y dominio.
...
Puedes apoyarte en: class, __init__(), self, property, classmethod, staticmethod, list, dict. No tienes que usarlas todas; el criterio esta en elegir las que realmente ordenan el problema.

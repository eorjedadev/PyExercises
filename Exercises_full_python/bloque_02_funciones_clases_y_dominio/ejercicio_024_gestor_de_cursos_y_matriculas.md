# Ejercicio 024. Gestor de cursos y matriculas
...
Construir una solucion funcional para `Gestor de cursos y matriculas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

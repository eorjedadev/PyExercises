# Ejercicio 025. Motor de reglas para promociones
...
Construir una solucion funcional para `Motor de reglas para promociones` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

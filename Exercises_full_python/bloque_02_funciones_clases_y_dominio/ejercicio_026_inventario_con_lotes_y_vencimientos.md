# Ejercicio 026. Inventario con lotes y vencimientos
...
Construir una solucion funcional para `Inventario con lotes y vencimientos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

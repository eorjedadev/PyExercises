# Ejercicio 029. Sistema de paquetes de envio
...
Construir una solucion funcional para `Sistema de paquetes de envio` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 030. Reservas de hotel por habitaciones
...
Construir una solucion funcional para `Reservas de hotel por habitaciones` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Tu solucion debe modelar una entidad principal llamada `Reserva` y una estructura que administre muchos elementos, por ejemplo `Calendario de reservas`. No te quedes en imprimir datos: el programa debe recibir, validar, transformar y mostrar informacion util.
...
- dos reservas no deben ocupar el mismo recurso al mismo tiempo.
- la fecha final no puede ser anterior a la inicial.
- una cancelacion debe conservar trazabilidad.
...
Piensa si tu solucion necesita funciones o metodos parecidos a estos: `crear_reserva()`, `esta_disponible()`, `cancelar_reserva()`, `reservas_del_dia()`, `validar_horario()`. No copies estos nombres sin pensar; usalos como pista para descubrir responsabilidades.

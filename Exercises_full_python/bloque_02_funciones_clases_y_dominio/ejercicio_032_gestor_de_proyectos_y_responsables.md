# Ejercicio 032. Gestor de proyectos y responsables
...
Construir una solucion funcional para `Gestor de proyectos y responsables` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 034. Sistema de reportes por departamento
...
Construir una solucion funcional para `Sistema de reportes por departamento` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 035. Mesa de ayuda con tickets
...
Construir una solucion funcional para `Mesa de ayuda con tickets` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Tu solucion debe modelar una entidad principal llamada `Ticket` y una estructura que administre muchos elementos, por ejemplo `Mesa de ayuda`. No te quedes en imprimir datos: el programa debe recibir, validar, transformar y mostrar informacion util.
...
- todo ticket debe tener prioridad.
- solo ciertos cambios de estado son validos.
- un ticket cerrado no deberia editarse sin motivo.
...
Piensa si tu solucion necesita funciones o metodos parecidos a estos: `crear_ticket()`, `asignar()`, `cambiar_estado()`, `filtrar_tickets()`, `resumen_prioridad()`. No copies estos nombres sin pensar; usalos como pista para descubrir responsabilidades.

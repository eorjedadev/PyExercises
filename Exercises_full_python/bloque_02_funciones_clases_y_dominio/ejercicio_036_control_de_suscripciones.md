# Ejercicio 036. Control de suscripciones
...
Construir una solucion funcional para `Control de suscripciones` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

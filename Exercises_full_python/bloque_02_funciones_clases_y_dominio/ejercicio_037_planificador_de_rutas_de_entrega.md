# Ejercicio 037. Planificador de rutas de entrega
...
Construir una solucion funcional para `Planificador de rutas de entrega` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 038. Gestor de eventos y participantes
...
Construir una solucion funcional para `Gestor de eventos y participantes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Tu solucion debe modelar una entidad principal llamada `EventoSeguridad` y una estructura que administre muchos elementos, por ejemplo `Bitacora de seguridad`. No te quedes en imprimir datos: el programa debe recibir, validar, transformar y mostrar informacion util.
...
- trabaja solo en laboratorio propio o datos simulados.
- no guardes secretos en texto plano.
- distingue advertencia de error critico.
...
Piensa si tu solucion necesita funciones o metodos parecidos a estos: `validar()`, `clasificar()`, `registrar_evento()`, `generar_reporte()`, `anonimizar()`. No copies estos nombres sin pensar; usalos como pista para descubrir responsabilidades.

# Ejercicio 039. Sistema de membresias
...
Construir una solucion funcional para `Sistema de membresias` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 040. Panel de indicadores de negocio
...
Construir una solucion funcional para `Panel de indicadores de negocio` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 042. Generador de reporte mensual desde CSV
...
Construir una solucion funcional para `Generador de reporte mensual desde CSV` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 043. Limpiador de carpetas por extension
...
Construir una solucion funcional para `Limpiador de carpetas por extension` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

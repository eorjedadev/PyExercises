# Ejercicio 045. Analizador de logs de aplicacion
...
Construir una solucion funcional para `Analizador de logs de aplicacion` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 047. Respaldador de carpetas comprimidas
...
Construir una solucion funcional para `Respaldador de carpetas comprimidas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

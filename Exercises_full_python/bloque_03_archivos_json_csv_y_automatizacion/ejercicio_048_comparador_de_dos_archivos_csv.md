# Ejercicio 048. Comparador de dos archivos CSV
...
Construir una solucion funcional para `Comparador de dos archivos CSV` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

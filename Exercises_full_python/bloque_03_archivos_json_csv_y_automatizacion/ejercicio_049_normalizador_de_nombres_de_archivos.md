# Ejercicio 049. Normalizador de nombres de archivos
...
Construir una solucion funcional para `Normalizador de nombres de archivos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

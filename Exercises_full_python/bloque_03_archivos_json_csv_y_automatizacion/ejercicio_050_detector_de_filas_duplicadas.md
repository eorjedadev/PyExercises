# Ejercicio 050. Detector de filas duplicadas
...
Construir una solucion funcional para `Detector de filas duplicadas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

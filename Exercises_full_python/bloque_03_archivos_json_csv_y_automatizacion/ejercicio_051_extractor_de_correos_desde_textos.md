# Ejercicio 051. Extractor de correos desde textos
...
Construir una solucion funcional para `Extractor de correos desde textos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 053. Bitacora diaria persistente
...
Construir una solucion funcional para `Bitacora diaria persistente` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

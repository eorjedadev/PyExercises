# Ejercicio 055. Exportador de inventario a varios formatos
...
Construir una solucion funcional para `Exportador de inventario a varios formatos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Tu solucion debe modelar una entidad principal llamada `Producto` y una estructura que administre muchos elementos, por ejemplo `Inventario`. No te quedes en imprimir datos: el programa debe recibir, validar, transformar y mostrar informacion util.
...
Piensa si tu solucion necesita funciones o metodos parecidos a estos: `agregar_producto()`, `buscar_producto()`, `actualizar_stock()`, `valor_total()`, `productos_bajo_stock()`. No copies estos nombres sin pensar; usalos como pista para descubrir responsabilidades.

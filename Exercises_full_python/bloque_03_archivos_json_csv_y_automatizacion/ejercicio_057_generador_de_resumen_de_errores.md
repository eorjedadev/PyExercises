# Ejercicio 057. Generador de resumen de errores
...
Construir una solucion funcional para `Generador de resumen de errores` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

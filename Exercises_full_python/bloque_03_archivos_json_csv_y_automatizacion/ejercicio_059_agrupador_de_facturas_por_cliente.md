# Ejercicio 059. Agrupador de facturas por cliente
...
Construir una solucion funcional para `Agrupador de facturas por cliente` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Tu solucion debe modelar una entidad principal llamada `Contacto` y una estructura que administre muchos elementos, por ejemplo `Agenda o CRM`. No te quedes en imprimir datos: el programa debe recibir, validar, transformar y mostrar informacion util.
...
- correo o telefono debe tener formato minimo valido.
- no debe haber nombres vacios.
- un contacto no debe duplicarse sin aviso.
...
Piensa si tu solucion necesita funciones o metodos parecidos a estos: `agregar_contacto()`, `buscar_contacto()`, `actualizar_contacto()`, `filtrar_contactos()`, `exportar_contactos()`. No copies estos nombres sin pensar; usalos como pista para descubrir responsabilidades.

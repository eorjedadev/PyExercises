# Ejercicio 060. Automatizador de checklist de proyecto
...
Construir una solucion funcional para `Automatizador de checklist de proyecto` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

## Area de entrenamiento

Archivos, JSON, CSV y automatizacion.
...
Puedes apoyarte en: pathlib.Path, open(), read_text(), write_text(), csv.DictReader, csv.DictWriter, json.dumps(), json.loads(). No tienes que usarlas todas; el criterio esta en elegir las que realmente ordenan el problema.

## Funciones o metodos que deberias considerar

Piensa si tu solucion necesita funciones o metodos parecidos a estos: `agregar()`, `buscar()`, `actualizar()`, `listar()`, `resumir()`. No copies estos nombres sin pensar; usalos como pista para descubrir responsabilidades.

# Ejercicio 061. Analisis de ventas por categoria
...
Construir una solucion funcional para `Analisis de ventas por categoria` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

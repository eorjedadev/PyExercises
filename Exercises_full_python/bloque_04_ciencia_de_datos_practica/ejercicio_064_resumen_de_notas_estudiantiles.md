# Ejercicio 064. Resumen de notas estudiantiles
...
Construir una solucion funcional para `Resumen de notas estudiantiles` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

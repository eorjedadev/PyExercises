# Ejercicio 065. Analisis de gastos por mes
...
Construir una solucion funcional para `Analisis de gastos por mes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

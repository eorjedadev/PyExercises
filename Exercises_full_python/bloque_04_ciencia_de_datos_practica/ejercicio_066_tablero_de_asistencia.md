# Ejercicio 066. Tablero de asistencia
...
Construir una solucion funcional para `Tablero de asistencia` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 067. Comparador de precios entre tiendas
...
Construir una solucion funcional para `Comparador de precios entre tiendas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

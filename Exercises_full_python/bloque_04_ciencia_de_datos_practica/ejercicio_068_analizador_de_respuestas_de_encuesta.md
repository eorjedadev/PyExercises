# Ejercicio 068. Analizador de respuestas de encuesta
...
Construir una solucion funcional para `Analizador de respuestas de encuesta` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

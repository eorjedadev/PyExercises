# Ejercicio 069. Reporte de clientes frecuentes
...
Construir una solucion funcional para `Reporte de clientes frecuentes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 070. Tendencia de ingresos semanales
...
Construir una solucion funcional para `Tendencia de ingresos semanales` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

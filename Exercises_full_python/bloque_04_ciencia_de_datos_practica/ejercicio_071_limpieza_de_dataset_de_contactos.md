# Ejercicio 071. Limpieza de dataset de contactos
...
Construir una solucion funcional para `Limpieza de dataset de contactos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

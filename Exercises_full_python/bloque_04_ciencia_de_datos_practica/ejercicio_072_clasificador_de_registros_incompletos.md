# Ejercicio 072. Clasificador de registros incompletos
...
Construir una solucion funcional para `Clasificador de registros incompletos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

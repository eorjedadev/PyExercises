# Ejercicio 075. Mapa simple de ubicaciones
...
Construir una solucion funcional para `Mapa simple de ubicaciones` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

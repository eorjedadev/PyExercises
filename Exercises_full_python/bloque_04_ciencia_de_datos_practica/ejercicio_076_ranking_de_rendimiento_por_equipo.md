# Ejercicio 076. Ranking de rendimiento por equipo
...
Construir una solucion funcional para `Ranking de rendimiento por equipo` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

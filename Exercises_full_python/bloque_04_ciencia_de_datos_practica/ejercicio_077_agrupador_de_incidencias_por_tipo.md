# Ejercicio 077. Agrupador de incidencias por tipo
...
Construir una solucion funcional para `Agrupador de incidencias por tipo` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

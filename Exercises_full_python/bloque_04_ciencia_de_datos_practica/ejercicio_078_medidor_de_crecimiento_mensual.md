# Ejercicio 078. Medidor de crecimiento mensual
...
Construir una solucion funcional para `Medidor de crecimiento mensual` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

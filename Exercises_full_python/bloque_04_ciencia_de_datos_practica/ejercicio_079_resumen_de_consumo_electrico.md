# Ejercicio 079. Resumen de consumo electrico
...
Construir una solucion funcional para `Resumen de consumo electrico` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 080. Explorador de datos de peliculas
...
Construir una solucion funcional para `Explorador de datos de peliculas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

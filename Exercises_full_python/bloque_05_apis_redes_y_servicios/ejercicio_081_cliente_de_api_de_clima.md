# Ejercicio 081. Cliente de API de clima
...
Construir una solucion funcional para `Cliente de API de clima` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

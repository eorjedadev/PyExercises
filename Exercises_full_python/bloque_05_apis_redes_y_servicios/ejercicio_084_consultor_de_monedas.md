# Ejercicio 084. Consultor de monedas
...
Construir una solucion funcional para `Consultor de monedas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

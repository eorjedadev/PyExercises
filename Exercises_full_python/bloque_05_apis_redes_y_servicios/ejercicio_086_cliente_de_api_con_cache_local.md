# Ejercicio 086. Cliente de API con cache local
...
Construir una solucion funcional para `Cliente de API con cache local` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

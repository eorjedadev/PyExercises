# Ejercicio 087. Verificador de enlaces
...
Construir una solucion funcional para `Verificador de enlaces` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

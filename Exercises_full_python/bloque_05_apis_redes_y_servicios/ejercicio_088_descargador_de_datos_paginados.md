# Ejercicio 088. Descargador de datos paginados
...
Construir una solucion funcional para `Descargador de datos paginados` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 089. Comparador de respuestas API
...
Construir una solucion funcional para `Comparador de respuestas API` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

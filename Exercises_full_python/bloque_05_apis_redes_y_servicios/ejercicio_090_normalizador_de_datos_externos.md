# Ejercicio 090. Normalizador de datos externos
...
Construir una solucion funcional para `Normalizador de datos externos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

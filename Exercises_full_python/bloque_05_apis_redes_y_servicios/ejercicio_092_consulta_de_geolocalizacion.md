# Ejercicio 092. Consulta de geolocalizacion
...
Construir una solucion funcional para `Consulta de geolocalizacion` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 093. Monitor de latencia basico
...
Construir una solucion funcional para `Monitor de latencia basico` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

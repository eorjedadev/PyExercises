# Ejercicio 094. Recolector de datos periodico
...
Construir una solucion funcional para `Recolector de datos periodico` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

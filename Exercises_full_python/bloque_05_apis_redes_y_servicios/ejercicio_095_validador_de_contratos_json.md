# Ejercicio 095. Validador de contratos JSON
...
Construir una solucion funcional para `Validador de contratos JSON` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

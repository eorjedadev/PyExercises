# Ejercicio 096. Explorador de endpoints
...
Construir una solucion funcional para `Explorador de endpoints` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 097. Cliente con reintentos controlados
...
Construir una solucion funcional para `Cliente con reintentos controlados` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

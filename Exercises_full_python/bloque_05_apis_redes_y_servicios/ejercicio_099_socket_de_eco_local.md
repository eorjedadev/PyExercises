# Ejercicio 099. Socket de eco local
...
Construir una solucion funcional para `Socket de eco local` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

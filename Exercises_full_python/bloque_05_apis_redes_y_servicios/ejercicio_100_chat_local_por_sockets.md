# Ejercicio 100. Chat local por sockets
...
Construir una solucion funcional para `Chat local por sockets` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

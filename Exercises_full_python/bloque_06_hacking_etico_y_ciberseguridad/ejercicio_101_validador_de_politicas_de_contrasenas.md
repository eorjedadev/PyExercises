# Ejercicio 101. Validador de politicas de contrasenas
...
Construir una solucion funcional para `Validador de politicas de contrasenas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 102. Analizador de intentos de login
...
Construir una solucion funcional para `Analizador de intentos de login` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

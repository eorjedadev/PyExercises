# Ejercicio 104. Verificador de hashes de archivos
...
Construir una solucion funcional para `Verificador de hashes de archivos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

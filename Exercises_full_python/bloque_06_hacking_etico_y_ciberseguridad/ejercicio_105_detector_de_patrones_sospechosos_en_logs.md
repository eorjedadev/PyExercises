# Ejercicio 105. Detector de patrones sospechosos en logs
...
Construir una solucion funcional para `Detector de patrones sospechosos en logs` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Puedes apoyarte en: hashlib, secrets, re, ipaddress, socket, ssl, base64, hmac. No tienes que usarlas todas; el criterio esta en elegir las que realmente ordenan el problema.

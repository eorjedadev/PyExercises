# Ejercicio 106. Clasificador de severidad de alertas
...
Construir una solucion funcional para `Clasificador de severidad de alertas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 107. Inventario de activos de red local
...
Construir una solucion funcional para `Inventario de activos de red local` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

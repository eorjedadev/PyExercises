# Ejercicio 108. Escaner controlado de puertos localhost
...
Construir una solucion funcional para `Escaner controlado de puertos localhost` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

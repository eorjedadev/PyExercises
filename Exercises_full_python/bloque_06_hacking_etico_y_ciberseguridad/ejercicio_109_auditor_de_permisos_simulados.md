# Ejercicio 109. Auditor de permisos simulados
...
Construir una solucion funcional para `Auditor de permisos simulados` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

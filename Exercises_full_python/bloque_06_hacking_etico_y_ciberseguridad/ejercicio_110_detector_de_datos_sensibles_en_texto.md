# Ejercicio 110. Detector de datos sensibles en texto
...
Construir una solucion funcional para `Detector de datos sensibles en texto` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

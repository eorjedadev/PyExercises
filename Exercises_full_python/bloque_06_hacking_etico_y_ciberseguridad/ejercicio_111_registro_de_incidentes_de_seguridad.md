# Ejercicio 111. Registro de incidentes de seguridad
...
Construir una solucion funcional para `Registro de incidentes de seguridad` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 112. Evaluador de fortaleza de claves API
...
Construir una solucion funcional para `Evaluador de fortaleza de claves API` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

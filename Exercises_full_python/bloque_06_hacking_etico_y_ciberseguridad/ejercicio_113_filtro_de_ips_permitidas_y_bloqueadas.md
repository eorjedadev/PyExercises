# Ejercicio 113. Filtro de IPs permitidas y bloqueadas
...
Construir una solucion funcional para `Filtro de IPs permitidas y bloqueadas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 114. Monitor de cambios en archivos criticos
...
Construir una solucion funcional para `Monitor de cambios en archivos criticos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

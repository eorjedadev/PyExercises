# Ejercicio 115. Analizador de cabeceras HTTP guardadas
...
Construir una solucion funcional para `Analizador de cabeceras HTTP guardadas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

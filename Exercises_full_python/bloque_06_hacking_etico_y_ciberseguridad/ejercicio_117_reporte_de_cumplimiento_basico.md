# Ejercicio 117. Reporte de cumplimiento basico
...
Construir una solucion funcional para `Reporte de cumplimiento basico` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

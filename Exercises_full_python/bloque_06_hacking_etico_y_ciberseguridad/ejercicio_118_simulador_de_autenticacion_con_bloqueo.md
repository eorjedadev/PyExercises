# Ejercicio 118. Simulador de autenticacion con bloqueo
...
Construir una solucion funcional para `Simulador de autenticacion con bloqueo` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 119. Verificador de integridad de respaldos
...
Construir una solucion funcional para `Verificador de integridad de respaldos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

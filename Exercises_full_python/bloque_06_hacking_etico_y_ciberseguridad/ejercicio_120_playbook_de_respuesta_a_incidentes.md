# Ejercicio 120. Playbook de respuesta a incidentes
...
Construir una solucion funcional para `Playbook de respuesta a incidentes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

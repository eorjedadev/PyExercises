# Ejercicio 121. Clasificador de mensajes por intencion
...
Construir una solucion funcional para `Clasificador de mensajes por intencion` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Puedes apoyarte en: Counter, re, json, csv, statistics, difflib, sklearn opcional, numpy opcional. No tienes que usarlas todas; el criterio esta en elegir las que realmente ordenan el problema.

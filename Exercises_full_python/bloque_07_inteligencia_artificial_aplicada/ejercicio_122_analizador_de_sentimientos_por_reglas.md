# Ejercicio 122. Analizador de sentimientos por reglas
...
Construir una solucion funcional para `Analizador de sentimientos por reglas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 123. Buscador de documentos similares
...
Construir una solucion funcional para `Buscador de documentos similares` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

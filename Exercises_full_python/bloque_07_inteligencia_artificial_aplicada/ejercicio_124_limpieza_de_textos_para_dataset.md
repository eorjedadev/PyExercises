# Ejercicio 124. Limpieza de textos para dataset
...
Construir una solucion funcional para `Limpieza de textos para dataset` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

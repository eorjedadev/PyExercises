# Ejercicio 125. Asistente de preguntas frecuentes
...
Construir una solucion funcional para `Asistente de preguntas frecuentes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 126. Detector de temas en comentarios
...
Construir una solucion funcional para `Detector de temas en comentarios` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 127. Evaluador simple de respuestas
...
Construir una solucion funcional para `Evaluador simple de respuestas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

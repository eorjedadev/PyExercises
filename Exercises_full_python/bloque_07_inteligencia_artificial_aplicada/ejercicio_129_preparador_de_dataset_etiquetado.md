# Ejercicio 129. Preparador de dataset etiquetado
...
Construir una solucion funcional para `Preparador de dataset etiquetado` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

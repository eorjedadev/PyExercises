# Ejercicio 130. Medidor de precision manual
...
Construir una solucion funcional para `Medidor de precision manual` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

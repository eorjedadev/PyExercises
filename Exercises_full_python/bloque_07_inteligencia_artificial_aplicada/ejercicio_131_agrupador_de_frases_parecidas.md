# Ejercicio 131. Agrupador de frases parecidas
...
Construir una solucion funcional para `Agrupador de frases parecidas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

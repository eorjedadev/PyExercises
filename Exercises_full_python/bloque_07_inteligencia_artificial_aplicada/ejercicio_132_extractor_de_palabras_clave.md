# Ejercicio 132. Extractor de palabras clave
...
Construir una solucion funcional para `Extractor de palabras clave` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

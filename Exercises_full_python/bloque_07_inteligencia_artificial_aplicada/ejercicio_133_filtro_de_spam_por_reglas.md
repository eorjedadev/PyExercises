# Ejercicio 133. Filtro de spam por reglas
...
Construir una solucion funcional para `Filtro de spam por reglas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 134. Generador de resumen por frecuencia
...
Construir una solucion funcional para `Generador de resumen por frecuencia` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

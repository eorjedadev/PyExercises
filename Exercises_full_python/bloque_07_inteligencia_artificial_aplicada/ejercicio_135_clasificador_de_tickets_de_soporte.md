# Ejercicio 135. Clasificador de tickets de soporte
...
Construir una solucion funcional para `Clasificador de tickets de soporte` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

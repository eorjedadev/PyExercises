# Ejercicio 136. Detector de anomalias simples
...
Construir una solucion funcional para `Detector de anomalias simples` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

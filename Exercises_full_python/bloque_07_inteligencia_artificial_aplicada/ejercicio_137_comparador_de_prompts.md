# Ejercicio 137. Comparador de prompts
...
Construir una solucion funcional para `Comparador de prompts` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

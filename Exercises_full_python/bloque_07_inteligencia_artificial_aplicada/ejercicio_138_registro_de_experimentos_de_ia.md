# Ejercicio 138. Registro de experimentos de IA
...
Construir una solucion funcional para `Registro de experimentos de IA` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

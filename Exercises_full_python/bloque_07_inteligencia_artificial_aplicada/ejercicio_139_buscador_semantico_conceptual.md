# Ejercicio 139. Buscador semantico conceptual
...
Construir una solucion funcional para `Buscador semantico conceptual` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 141. Login grafico con validacion
...
Construir una solucion funcional para `Login grafico con validacion` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 142. Agenda visual de contactos
...
Construir una solucion funcional para `Agenda visual de contactos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 143. Inventario con tabla Tkinter
...
Construir una solucion funcional para `Inventario con tabla Tkinter` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

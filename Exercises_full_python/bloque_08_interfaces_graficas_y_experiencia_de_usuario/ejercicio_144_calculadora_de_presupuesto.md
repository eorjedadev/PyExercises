# Ejercicio 144. Calculadora de presupuesto
...
Construir una solucion funcional para `Calculadora de presupuesto` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

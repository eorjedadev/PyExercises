# Ejercicio 145. Gestor de tareas con filtros
...
Construir una solucion funcional para `Gestor de tareas con filtros` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

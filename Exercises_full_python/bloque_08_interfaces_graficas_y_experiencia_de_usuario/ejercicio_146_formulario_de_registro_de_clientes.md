# Ejercicio 146. Formulario de registro de clientes
...
Construir una solucion funcional para `Formulario de registro de clientes` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

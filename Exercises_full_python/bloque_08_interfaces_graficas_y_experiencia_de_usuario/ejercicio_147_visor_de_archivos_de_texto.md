# Ejercicio 147. Visor de archivos de texto
...
Construir una solucion funcional para `Visor de archivos de texto` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

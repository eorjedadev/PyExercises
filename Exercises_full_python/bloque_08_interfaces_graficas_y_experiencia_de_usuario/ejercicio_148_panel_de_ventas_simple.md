# Ejercicio 148. Panel de ventas simple
...
Construir una solucion funcional para `Panel de ventas simple` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

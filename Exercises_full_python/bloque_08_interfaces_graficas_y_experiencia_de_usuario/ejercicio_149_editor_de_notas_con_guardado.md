# Ejercicio 149. Editor de notas con guardado
...
Construir una solucion funcional para `Editor de notas con guardado` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

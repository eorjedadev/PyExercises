# Ejercicio 150. Cronometro de productividad
...
Construir una solucion funcional para `Cronometro de productividad` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

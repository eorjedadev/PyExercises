# Ejercicio 151. Conversor de unidades visual
...
Construir una solucion funcional para `Conversor de unidades visual` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 152. Buscador en CSV con interfaz
...
Construir una solucion funcional para `Buscador en CSV con interfaz` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

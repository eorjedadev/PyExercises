# Ejercicio 153. Monitor de logs en ventana
...
Construir una solucion funcional para `Monitor de logs en ventana` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

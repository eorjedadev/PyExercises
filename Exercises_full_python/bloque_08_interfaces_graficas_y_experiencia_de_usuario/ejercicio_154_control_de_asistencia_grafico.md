# Ejercicio 154. Control de asistencia grafico
...
Construir una solucion funcional para `Control de asistencia grafico` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

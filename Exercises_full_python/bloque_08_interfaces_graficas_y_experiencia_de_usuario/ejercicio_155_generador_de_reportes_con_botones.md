# Ejercicio 155. Generador de reportes con botones
...
Construir una solucion funcional para `Generador de reportes con botones` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 156. Validador de contrasenas visual
...
Construir una solucion funcional para `Validador de contrasenas visual` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

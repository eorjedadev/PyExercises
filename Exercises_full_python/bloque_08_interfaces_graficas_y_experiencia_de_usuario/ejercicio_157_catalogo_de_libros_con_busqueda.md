# Ejercicio 157. Catalogo de libros con busqueda
...
Construir una solucion funcional para `Catalogo de libros con busqueda` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

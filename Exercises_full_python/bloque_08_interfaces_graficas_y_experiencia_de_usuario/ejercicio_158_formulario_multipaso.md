# Ejercicio 158. Formulario multipaso
...
Construir una solucion funcional para `Formulario multipaso` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

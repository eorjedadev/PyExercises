# Ejercicio 160. Mini dashboard local
...
Construir una solucion funcional para `Mini dashboard local` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

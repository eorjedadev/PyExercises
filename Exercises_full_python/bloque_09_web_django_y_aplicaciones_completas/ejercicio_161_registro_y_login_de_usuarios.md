# Ejercicio 161. Registro y login de usuarios
...
Construir una solucion funcional para `Registro y login de usuarios` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

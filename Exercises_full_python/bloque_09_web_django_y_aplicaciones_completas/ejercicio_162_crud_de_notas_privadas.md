# Ejercicio 162. CRUD de notas privadas
...
Construir una solucion funcional para `CRUD de notas privadas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 163. Blog con autores y borradores
...
Construir una solucion funcional para `Blog con autores y borradores` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

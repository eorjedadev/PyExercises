# Ejercicio 164. Sistema de tickets web
...
Construir una solucion funcional para `Sistema de tickets web` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 165. Inventario web con categorias
...
Construir una solucion funcional para `Inventario web con categorias` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 167. Agenda web con recordatorios
...
Construir una solucion funcional para `Agenda web con recordatorios` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 168. Biblioteca con prestamos
...
Construir una solucion funcional para `Biblioteca con prestamos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

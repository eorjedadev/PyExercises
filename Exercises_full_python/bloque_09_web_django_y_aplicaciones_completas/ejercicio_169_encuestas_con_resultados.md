# Ejercicio 169. Encuestas con resultados
...
Construir una solucion funcional para `Encuestas con resultados` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 170. Catalogo de productos
...
Construir una solucion funcional para `Catalogo de productos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

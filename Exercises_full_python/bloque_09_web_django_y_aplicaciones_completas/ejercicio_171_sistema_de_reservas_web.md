# Ejercicio 171. Sistema de reservas web
...
Construir una solucion funcional para `Sistema de reservas web` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

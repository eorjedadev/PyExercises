# Ejercicio 172. Dashboard de ventas
...
Construir una solucion funcional para `Dashboard de ventas` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 174. Gestor de archivos subidos
...
Construir una solucion funcional para `Gestor de archivos subidos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

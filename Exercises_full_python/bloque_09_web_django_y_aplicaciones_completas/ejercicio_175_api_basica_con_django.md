# Ejercicio 175. API basica con Django
...
Construir una solucion funcional para `API basica con Django` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

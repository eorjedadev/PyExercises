# Ejercicio 176. Permisos por rol
...
Construir una solucion funcional para `Permisos por rol` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

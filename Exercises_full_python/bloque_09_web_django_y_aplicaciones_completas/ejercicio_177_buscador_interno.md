# Ejercicio 177. Buscador interno
...
Construir una solucion funcional para `Buscador interno` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

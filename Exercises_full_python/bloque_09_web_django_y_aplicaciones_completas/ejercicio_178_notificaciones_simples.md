# Ejercicio 178. Notificaciones simples
...
Construir una solucion funcional para `Notificaciones simples` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 180. Preparacion para despliegue
...
Construir una solucion funcional para `Preparacion para despliegue` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

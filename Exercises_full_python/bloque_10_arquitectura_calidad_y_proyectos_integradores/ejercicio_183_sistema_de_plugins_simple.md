# Ejercicio 183. Sistema de plugins simple
...
Construir una solucion funcional para `Sistema de plugins simple` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

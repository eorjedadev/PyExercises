# Ejercicio 184. Motor de reglas configurable
...
Construir una solucion funcional para `Motor de reglas configurable` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

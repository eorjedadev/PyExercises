# Ejercicio 185. Auditor de calidad de datos
...
Construir una solucion funcional para `Auditor de calidad de datos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

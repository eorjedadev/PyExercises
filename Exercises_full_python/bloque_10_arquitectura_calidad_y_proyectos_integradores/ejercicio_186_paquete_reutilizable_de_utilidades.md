# Ejercicio 186. Paquete reutilizable de utilidades
...
Construir una solucion funcional para `Paquete reutilizable de utilidades` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

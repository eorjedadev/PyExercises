# Ejercicio 187. CLI con subcomandos
...
Construir una solucion funcional para `CLI con subcomandos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

# Ejercicio 188. Aplicacion con logs rotativos
...
Construir una solucion funcional para `Aplicacion con logs rotativos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

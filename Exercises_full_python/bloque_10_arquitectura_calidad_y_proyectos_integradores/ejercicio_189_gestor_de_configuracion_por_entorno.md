# Ejercicio 189. Gestor de configuracion por entorno
...
Construir una solucion funcional para `Gestor de configuracion por entorno` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

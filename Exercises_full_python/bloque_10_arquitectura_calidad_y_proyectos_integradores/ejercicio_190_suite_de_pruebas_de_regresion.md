# Ejercicio 190. Suite de pruebas de regresion
...
Construir una solucion funcional para `Suite de pruebas de regresion` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

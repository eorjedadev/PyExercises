# Ejercicio 191. Simulador de cola de trabajos
...
Construir una solucion funcional para `Simulador de cola de trabajos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

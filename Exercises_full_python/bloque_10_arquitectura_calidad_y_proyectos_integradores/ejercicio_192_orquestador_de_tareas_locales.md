# Ejercicio 192. Orquestador de tareas locales
...
Construir una solucion funcional para `Orquestador de tareas locales` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

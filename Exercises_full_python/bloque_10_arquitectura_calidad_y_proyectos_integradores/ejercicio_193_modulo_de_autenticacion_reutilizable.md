# Ejercicio 193. Modulo de autenticacion reutilizable
...
Construir una solucion funcional para `Modulo de autenticacion reutilizable` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

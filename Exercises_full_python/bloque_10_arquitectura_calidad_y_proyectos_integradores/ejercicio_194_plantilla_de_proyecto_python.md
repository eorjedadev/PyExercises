# Ejercicio 194. Plantilla de proyecto Python
...
Construir una solucion funcional para `Plantilla de proyecto Python` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

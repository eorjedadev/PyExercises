# Ejercicio 195. Migrador de datos entre formatos
...
Construir una solucion funcional para `Migrador de datos entre formatos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.
...
Piensa si tu solucion necesita funciones o metodos parecidos a estos: `cargar_dataset()`, `validar_columnas()`, `limpiar_fila()`, `calcular_metricas()`, `generar_reporte()`, `validar_configuracion()`, `registrar_log()`. No copies estos nombres sin pensar; usalos como pista para descubrir responsabilidades.

# Ejercicio 196. Validador de contratos internos
...
Construir una solucion funcional para `Validador de contratos internos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

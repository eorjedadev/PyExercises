# Ejercicio 197. Sistema de eventos y listeners
...
Construir una solucion funcional para `Sistema de eventos y listeners` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

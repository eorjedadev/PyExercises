# Ejercicio 199. Monitor de salud de procesos
...
Construir una solucion funcional para `Monitor de salud de procesos` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

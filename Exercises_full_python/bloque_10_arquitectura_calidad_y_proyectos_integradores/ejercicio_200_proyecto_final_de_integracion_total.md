# Ejercicio 200. Proyecto final de integracion total
...
Construir una solucion funcional para `Proyecto final de integracion total` usando una estructura ordenada. El programa debe tener una entrada de datos, una capa de procesamiento y una salida verificable. Evita resolverlo todo dentro de un solo bloque.

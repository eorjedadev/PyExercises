# Ejercicio 203. Inventario local de hardware simulado
...
Construir una herramienta o modulo para `Inventario local de hardware simulado`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

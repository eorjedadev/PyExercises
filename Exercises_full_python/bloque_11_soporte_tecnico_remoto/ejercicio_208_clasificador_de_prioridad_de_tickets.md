# Ejercicio 208. Clasificador de prioridad de tickets
...
Construir una herramienta o modulo para `Clasificador de prioridad de tickets`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

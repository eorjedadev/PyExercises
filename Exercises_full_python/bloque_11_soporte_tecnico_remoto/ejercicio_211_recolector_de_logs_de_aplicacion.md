# Ejercicio 211. Recolector de logs de aplicacion
...
Construir una herramienta o modulo para `Recolector de logs de aplicacion`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

# Ejercicio 215. Verificador de puertos locales autorizados
...
Construir una herramienta o modulo para `Verificador de puertos locales autorizados`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

# Ejercicio 216. Control de respaldos de usuario
...
Construir una herramienta o modulo para `Control de respaldos de usuario`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

# Ejercicio 219. Base de conocimiento local
...
Construir una herramienta o modulo para `Base de conocimiento local`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

# Ejercicio 223. Detector de reinicios repetidos desde logs
...
Construir una herramienta o modulo para `Detector de reinicios repetidos desde logs`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

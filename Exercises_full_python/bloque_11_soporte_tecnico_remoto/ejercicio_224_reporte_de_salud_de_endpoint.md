# Ejercicio 224. Reporte de salud de endpoint
...
Construir una herramienta o modulo para `Reporte de salud de endpoint`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

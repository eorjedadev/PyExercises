# Ejercicio 226. Extractor de datos de capturas de error
...
Construir una herramienta o modulo para `Extractor de datos de capturas de error`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

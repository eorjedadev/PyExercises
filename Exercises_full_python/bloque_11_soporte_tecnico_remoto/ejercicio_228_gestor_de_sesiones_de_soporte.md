# Ejercicio 228. Gestor de sesiones de soporte
...
Construir una herramienta o modulo para `Gestor de sesiones de soporte`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

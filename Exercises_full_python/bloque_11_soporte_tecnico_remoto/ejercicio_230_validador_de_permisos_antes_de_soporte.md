# Ejercicio 230. Validador de permisos antes de soporte
...
Construir una herramienta o modulo para `Validador de permisos antes de soporte`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

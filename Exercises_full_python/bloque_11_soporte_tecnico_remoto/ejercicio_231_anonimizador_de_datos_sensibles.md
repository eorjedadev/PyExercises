# Ejercicio 231. Anonimizador de datos sensibles
...
Construir una herramienta o modulo para `Anonimizador de datos sensibles`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

# Ejercicio 232. Comparador de configuraciones entre equipos
...
Construir una herramienta o modulo para `Comparador de configuraciones entre equipos`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.

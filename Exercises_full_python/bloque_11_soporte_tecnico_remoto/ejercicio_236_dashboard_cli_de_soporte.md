# Ejercicio 236. Dashboard CLI de soporte
...
Construir una herramienta o modulo para `Dashboard CLI de soporte`. Debe recibir datos, validarlos, aplicar reglas, producir una salida clara y registrar lo suficiente para que otra persona pueda entender que paso.
